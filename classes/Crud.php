...
class Crud {
    ...
    public function DeleteWhere($table_name, $id_name, $id_value, $where, $where_clause)
    {
        $sql = "DELETE FROM $table_name WHERE $id_name = $id_value AND $where = $where_clause";
        $this->con->query($sql);
    }
    ...
    public function SelectWhereOrderBy($table_name, $where, $where_clause, $order_by_key)
    {
        $sql = "SELECT * FROM $table_name WHERE $where = $where_clause ORDER BY $order_by_key DESC";
        $result = $this->con->query($sql);
        $row = $result->fetch_object();
        return $row;
    }
    ...
    {
        $sql = "SELECT * FROM $table_name WHERE $id_name = $id_value AND $where = $where_clause AND $where2 = $where_clause2";
        $result = $this->con->query($sql);
        return $result;
    }

    public function SelectAllWhereOrder($table_name, $id_name, $id_value, $where, $where_clause, $order_by, $keyword)
    {
    ...
    public function SelectCountID($table_name, $where_name, $where_value)
      {
          $sql = "SELECT count(id) as Amount FROM $table_name WHERE $where_name = $where_value";
          $result = $this->con->query($sql);
          $row = $result->fetch_object();
          return $row;
      }
